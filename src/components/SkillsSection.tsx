...
const SkillsSection = () => {
  ...
  return (
    <section
      id="skills"
      ref={sectionRef}
      className="relative overflow-hidden bg-[#020408] flex flex-col items-center pt-32 sm:pt-24 pb-12"
    >
      ...
      <div className="container mx-auto px-4 relative z-20 text-center mb-2">
        <ScrollReveal>
          <div className="inline-block">
            <div className="flex items-center gap-4 justify-center">
              <div className="w-3 h-3 rounded-full bg-primary shadow-[0_0_20px_rgba(0,242,255,0.8)] animate-pulse" />
              <h2 className="text-4xl md:text-[6rem] font-black tracking-tighter text-white uppercase italic leading-none">
